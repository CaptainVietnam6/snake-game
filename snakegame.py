...
screen_size_x = 800 #define x-axis screen size in pixels
screen_size_y = 450 #define y-axis screen size in pixels

half_screen_size_x = 400 #defines HALF of x screen size in pixels
half_screen_size_y = 225 #defines HALF of y screen size in pixels 

clock = pygame.time.Clock()
dis = pygame.display.set_mode((screen_size_x, screen_size_y)) #sets display size in pixels, keep at 16:9 aspect ratio
pygame.display.update()
pygame.display.set_caption("Snake game made with love by Kiet! (≧▽≦)")
